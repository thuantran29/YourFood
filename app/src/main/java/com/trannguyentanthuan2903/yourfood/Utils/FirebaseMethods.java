...
import com.trannguyentanthuan2903.yourfood.Profile.AccountSettingsActivity;
...
import com.trannguyentanthuan2903.yourfood.models.UserAccountSettings;
import com.trannguyentanthuan2903.yourfood.models.UserSettings;
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    @SuppressWarnings("VisibleForTests")  Uri firebaseUrl = taskSnapshot.getDownloadUrl();
...
//                    addPhotoToDatabase(caption, firebaseUrl.toString());
    ...
    public void upLoadNewPhotos(String photoType, final String caption, final int count,
                                final String locate, final String lat, final String lon,
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    //add the new photo to 'photos' node and 'user_photos' node
                    addPhotoToDatabase(caption, locate,lat,lon,firebaseUrl.toString());
    ...
    private String getTimestamp(){
        ...
        sdf.setTimeZone(android.icu.util.TimeZone.getTimeZone(TimeZone.getTimeZone("Asia/Ho_Chi_Minh").toString()));
        return sdf.format(new Date());
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    private void addPhotoToDatabase(String caption, String locate,String lat,String lon, String url){
        ...
        Toast.makeText(mContext, locate + lat + lon, Toast.LENGTH_SHORT).show();
    }
